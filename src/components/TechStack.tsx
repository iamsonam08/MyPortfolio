...
const TechCard: React.FC<TechCardProps> = ({ category, index }) => {
  ...
  return (
    <motion.div
      ...
      className="saas-card p-6 sm:p-8 flex flex-col justify-between space-y-6 hover:-translate-y-0.5 hover:border-[#0F766E]/40 hover:shadow-md transition-all duration-200 group"
    >
      <div className="space-y-4">
        {/* Category Header with Icon & Title */}
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-[#0F766E]/10 border border-[#0F766E]/20 flex items-center justify-center text-[#0F766E] shrink-0 group-hover:scale-105 transition-transform duration-200">
          ...
          <div>
            ...
            <span className="text-[10px] font-mono text-[#0F766E] uppercase tracking-wider font-semibold">
      ...
      <div className="pt-2 border-t border-[#E2E8F0]/80 dark:border-[#1E293B]/80">
        <div className="flex flex-wrap gap-2">
          {category.skills.map((skill) => (
            <span
              key={skill}
              className="px-3 py-1.5 rounded-lg bg-[#F8FAFC] dark:bg-[#0B1220] border border-[#E2E8F0] dark:border-[#1E293B] text-xs font-medium text-[#0F172A] dark:text-[#F8FAFC] shadow-2xs hover:border-[#0F766E]/40 hover:bg-white dark:hover:bg-[#111827] transition-all duration-150"
            >
              {skill}
            </span>
          ))}
...
export const TechStack = () => {
  return (
    <section id="tech-stack-section" className="py-12 sm:py-20">
